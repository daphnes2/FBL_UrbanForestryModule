...
//===================================================================
// Menu: icon rail + flyout panels (Info / Layers / Legend / Filters)
//
// Panels open independently now - opening one no longer closes the
// others, so e.g. Legend and Filters can both stay visible side by
// side (they're siblings in .menu-wrap, a flex row, so multiple
// .active panels naturally lay out next to each other).
//===================================================================
...
// Small × in each panel's header, per the prototype - closes only that
// one panel, leaving any others open.
document.querySelectorAll('.panel-close').forEach((closeBtn) => {
    closeBtn.addEventListener('click', () => {
        const panel = closeBtn.closest('.tab-panel');
